...
/// <remarks>
/// <para>
/// 默认实现 <see cref="CpuTensorPrimitivesScorer"/> 内嵌在 <c>DotVector.Core</c>，
/// 与 <see cref="Distance"/> 在 scalar 路径下 bit-identical。
/// </para>
/// <para>
/// 加速实现（如 <c>OnnxRuntimeScorer</c>）位于独立 NuGet 包 <c>DotVector.Acceleration.*</c>，
/// 不进入 <c>DotVector.Core</c>，以保持核心库零第三方运行时依赖。
/// </para>
/// <para>
/// 实现需保证：
/// <list type="bullet">
